...
class MagicHomeLight(MagicHomeDevice):
    ...
    def set_brightness(self, brightness):
        ...
        self.api.device_control(self.obj_id, 'SetBrightness', {'value': value})
    ...
    def set_color(self, color):
        ...
        if hsv_color['saturation'] == 0:
            hsv_color['hue'] = 0
        self.api.device_control(self.obj_id, 'SetColor', {'color': hsv_color})

    def set_color_temp(self, color_temp):
        self.api.device_control(self.obj_id, 'SetColorTemperature', 
            {'value': color_temp})
